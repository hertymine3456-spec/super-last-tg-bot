...
async def group_reply_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # This handler exists to avoid NameError when the group reply handler is registered.
    # Current bot logic relies on /publish and inline buttons, so no action is required here.
    return
